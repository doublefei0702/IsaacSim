...
def convert_to_yolo(
    ...
    for idx, rgb_file in enumerate(rgb_files):
        ...
        # 从 rgb_0000 提取索引，构建 instance_segmentation_0000
        # 假设 RGB 文件名格式为 xxx_NNNN.ext
        ...
        # 读取实例分割 mask
        instance_file = instance_files[instance_stem]
        ...
        # 读取映射文件
        mapping_file = mapping_files[instance_stem]
